...
namespace CarFleetPro.API.Migrations
{
    ...
    [Migration("20260511174323_AddPricePolicyAndVehicleSegments")]
    partial class AddPricePolicyAndVehicleSegments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarFleetPro.API.Models.CarBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CarFleetPro.API.Models.DamageRecord", b =>
                {
                    b.Property<int>("DamageRecordId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("DamageRecordId"));
            ...
            modelBuilder.Entity("CarFleetPro.API.Models.DamageRecord", b =>
                {
                    b.HasOne("CarFleetPro.API.Models.AppUser", "ReportedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CarFleetPro.API.Models.Notification", b =>
                {
                    b.HasOne("CarFleetPro.API.Models.AppUser", "TargetUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CarFleetPro.API.Models.VehicleImage", b =>
                {
                    b.HasOne("CarFleetPro.API.Models.AppUser", "UploadedByUser")
                        .WithMany()
